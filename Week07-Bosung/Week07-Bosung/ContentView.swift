            ...
            .confirmationDialog("Select a filter",
                ...
                Group {
                    Button("Cancel", role: .cancel) {}
                                ...
                                .alert("OHHohh!", isPresented: $showingSaveError) {
                                    Button("Ok") {}
                                } message: {
                                    Text("Sorry, there was an error savingyour image - please check that you have allowed permission for this app to save Photos🙀!")
                                }
        }
    }
